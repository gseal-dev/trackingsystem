...
<div class="page-container">
  <div class="container" style="max-width: 900px;">
    <div class="page-header mb-3 d-flex align-items-end justify-content-between flex-wrap gap-3">
      ...
      <a href="{{ route('admin.userManagement.addForm', ['type' => 'admins']) }}" class="btn btn-brand"><i class="bi bi-person-plus"></i> Add Admin</a>
    </div>
      ...
      @forelse($users as $user)
        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
          ...
          <div class="d-flex gap-2">
            <a href="{{ route('admin.userManagement.editForm', ['type' => 'admins', 'user' => $user]) }}" class="btn btn-outline-secondary btn-sm">Edit</a>
            <form action="{{ route('admin.userManagement.delete', ['type' => 'admins', 'user' => $user]) }}" method="POST" class="d-inline"
