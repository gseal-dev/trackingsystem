      ...
      @forelse($users as $user)
        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
          ...
          <div class="d-flex gap-2">
            <a href="{{ route('admin.userManagement.editForm', ['type' => 'auditors', 'user' => $user]) }}" class="btn btn-outline-secondary btn-sm">Edit</a>
            <form action="{{ route('admin.userManagement.delete', ['type' => 'auditors', 'user' => $user]) }}" method="POST" class="d-inline"
