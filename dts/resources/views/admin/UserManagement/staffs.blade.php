  ...
  <div class="container" style="max-width: 900px;">
    <div class="page-header mb-3 d-flex align-items-end justify-content-between flex-wrap gap-3">
      <div>
        ...
        <div class="text-muted">Manage staff users</div>
      </div>
      <a href="{{ route('admin.userManagement.addForm', ['type' => 'staffs']) }}" class="btn btn-brand"><i class="bi bi-person-plus"></i> Add Staff</a>
    </div>
      ...
      @forelse($users as $user)
        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
          ...
          <div class="d-flex gap-2">
            <a href="{{ route('admin.userManagement.editForm', ['type' => 'staffs', 'user' => $user]) }}" class="btn btn-outline-secondary btn-sm">Edit</a>
            <form action="{{ route('admin.userManagement.delete', ['type' => 'staffs', 'user' => $user]) }}" method="POST" class="d-inline"
