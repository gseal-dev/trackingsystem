  ...
  <div class="container" style="max-width: 1100px;">
    <div class="page-header mb-3 d-flex align-items-end justify-content-between flex-wrap gap-3">
      <div>
        ...
        <div class="text-muted">View your documents currently in review and their current office</div>
      </div>
    ...
    <div class="card-surface p-3">
      @if($documents->isEmpty())
        <div class="alert alert-info mb-0">No documents currently in review.</div>
      @else
